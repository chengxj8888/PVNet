...
import pvnet.Datasets.datasets as datasets
import pvnet.models.models as models
...
@click.option('--checkpoint',
              ...
              default='ckpt/checkpoints/sk.ckpt')
...
def main(config, weights, checkpoint, test):
    ...
    checkpoint_saver = ModelCheckpoint(filename=cfg['experiment']['id']+'_{epoch:02d}', save_top_k=-1)
